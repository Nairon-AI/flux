...
|-------|--------|---------|
| [Codex CLI](https://github.com/openai/codex) | ✅ Primary Driver | `npm install -g @openai/codex && codex login` |
...
**Primary install path** — use Codex CLI for implementation:
```bash
