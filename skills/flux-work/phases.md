...
- If the task touches user-facing frontend code, the worker must load `taste-skill` plus the relevant installed UI skills from `.codex/skills/` or `.claude/skills/` before writing code.
