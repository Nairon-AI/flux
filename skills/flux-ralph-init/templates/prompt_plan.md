...
3) Plan review gate:
   - If PLAN_REVIEW=rp: run `/flux:plan-review {{EPIC_ID}} --review=rp`
   - If PLAN_REVIEW=codex: run `/flux:plan-review {{EPIC_ID}} --review=codex`
   - If PLAN_REVIEW=export: run `/flux:plan-review {{EPIC_ID}} --review=export`
   - If PLAN_REVIEW=none:
