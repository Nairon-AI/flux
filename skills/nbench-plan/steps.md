...
- Tasks are small enough for one `/nbench:work` iteration (split if not)
...
1. Invoke `/nbench:plan-review` with the epic ID
...
Next steps:
1) Start work: `/nbench:work fn-N-slug`
2) Refine via interview: `/nbench:interview fn-N-slug`
3) Review the plan: `/nbench:plan-review fn-N-slug`
