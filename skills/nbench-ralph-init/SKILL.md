---
name: nbench-ralph-init
description: Scaffold repo-local Ralph autonomous harness under scripts/ralph/. Use when user runs /nbench:ralph-init.
...
7. Print next steps (run from terminal, NOT inside Claude Code):
   ...
   **If UPDATE_MODE=0:**
   ...
   Maintenance:
   - Re-run /nbench:ralph-init after plugin updates to refresh scripts
