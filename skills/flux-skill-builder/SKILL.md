...
description: >
  Autonomously create production-grade Claude Code skills from a brief description.
...
Autonomously create production-grade Claude Code skills from a short description. No interview loops — the agent researches, infers, drafts, validates, and installs in one pass.
...
| 4. Deliver | Install to `.claude/skills/<name>/`, generate trigger test report | Installed and ready |
