---
name: nbench-impl-review
description: John Carmack-level implementation review via RepoPrompt or Codex. Use when reviewing code changes, PRs, or implementations. Triggers on /nbench:impl-review.
...
if [[ "$BACKEND" == "ASK" ]]; then
  ...
  echo "Run /nbench:setup to configure, or pass --review=rp|codex|none"
  exit 1
fi
...
4. **Re-review**:
   - **Codex**: Re-run `nbenchctl codex impl-review` (receipt enables context)
