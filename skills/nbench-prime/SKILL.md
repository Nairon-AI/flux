---
name: nbench-prime
description: Comprehensive codebase assessment for agent and production readiness. Scans 8 pillars (48 criteria), verifies commands work, checks GitHub settings. Reports everything, fixes agent readiness only. Triggers on /nbench:prime.
...
Examples:
- `/nbench:prime`
- `/nbench:prime --report-only`
- `/nbench:prime ~/other-project`
