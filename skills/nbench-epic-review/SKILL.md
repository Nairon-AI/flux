...
description: Epic completion review - verifies all epic tasks implement spec requirements. Triggers on /nbench:epic-review.
...
4. **Re-review**:
   - **Codex**: Re-run `nbenchctl codex completion-review` (receipt enables context)
