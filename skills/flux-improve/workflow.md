...
### Auto-Build Skills from Behavioral Breakdown
...
2. Invoke `flux-skill-builder` with the identified workflow as input. The builder handles research, drafting, validation, and repo-local installation into the project skill folders.
