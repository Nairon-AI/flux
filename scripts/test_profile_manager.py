...
def test_install_item_defaults_project_skills_to_skill_exists_verification():
    payload = {
        "item": {
            "name": "baseline-ui",
            "category": "skill",
    ...
    assert result["verification"] == "skill_exists"
    assert result["verify_command"][2] == "skill_exists"
...
def run_all_tests():
    ...
    test_install_item_defaults_project_skills_to_skill_exists_verification()
