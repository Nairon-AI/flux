"""
fluxctl_pkg.codex - Codex CLI helpers (require_codex, run_codex_exec, sandbox, verdict parsing).
"""
...
def run_codex_exec(
    ...
    Model: FLUX_CODEX_MODEL env > parameter > default (`gpt-5.3-codex`).
    ...
    """
    codex = require_codex()
    # Model priority: env > parameter > default (Codex-first default)
    effective_model = os.environ.get("FLUX_CODEX_MODEL") or model or "gpt-5.3-codex"
