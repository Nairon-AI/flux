---
name: flux:meditate
description: Audit and evolve the brain vault - prune outdated content, discover new principles
argument-hint: ""
---
...
# IMPORTANT: This command MUST invoke the skill `flux-meditate`

The ONLY purpose of this command is to call the `flux-meditate` skill. You MUST use that skill now.

**User request:** $ARGUMENTS

Pass the user request to the skill. The skill handles brain auditing, pruning, and principle extraction.
