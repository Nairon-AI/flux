---
name: flux:ruminate
description: Mine past Claude Code conversations for uncaptured patterns and learnings
...
# IMPORTANT: This command MUST invoke the skill `flux-ruminate`

The ONLY purpose of this command is to call the `flux-ruminate` skill. You MUST use that skill now.

**User request:** $ARGUMENTS

Pass the user request to the skill. The skill handles conversation mining and brain updates.
